package com.github.leeyazhou.scf.protocol;
...
public class ProtocolConst {
  ...
  public static Object fromBytes(byte[] buffer) throws Exception {
    if (buffer != null && buffer.length > 0) {
      ...
      if (version == com.github.leeyazhou.scf.protocol.sfp.Protocol.VERSION) {
        return com.github.leeyazhou.scf.protocol.sfp.Protocol.fromBytes(buffer);
      }
    }
