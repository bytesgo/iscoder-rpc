...
import com.iscoder.scf.common.utils.XMLUtil;
...
public final class ServiceConfig {
  ...
  public static ServiceConfig GetConfig(String serviceName) throws Exception {
    File f = new File(SCFInit.DEFAULT_CONFIG_PATH);
    if (!f.exists()) {
      throw new Exception("scf.config not fond:" + SCFInit.DEFAULT_CONFIG_PATH);
    }

    Element xmlDoc = XMLUtil.GetXmlDoc(SCFInit.DEFAULT_CONFIG_PATH);
