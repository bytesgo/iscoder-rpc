...
public class DESCoderUtil {
  ...
  public static DESCoderUtil getInstance() {
    return new DESCoderUtil();
  }
  ...
  public String initkeyString(String key) throws Exception {
    return Base64Util.encodeBase64String(initkey(key));
  }
  ...
  public String encryptString(byte[] data, byte[] key) throws Exception {
    return Base64Util.encodeBase64String(encrypt(data, key));
  }
  ...
  private String decrypt(String data, String key) throws Exception {
    return new String(decrypt(Base64Util.decodeBase64(data), key.getBytes(CHAR_ENCODING)));
  }
  ...
  public String encryptNetString(String data, String key) throws Exception {
    keyLength(key);
    return Base64Util.encodeBase64String(encryptNetByte(data, key));
  }
  ...
  public String decryptNetString(String data, String key) throws Exception {
    keyLength(key);
    return new String(decryptNet(Base64Util.decodeBase64(data), key.getBytes(CHAR_ENCODING)));
  }
  ...
  public static void main(String[] args) throws Exception {
    DESCoderUtil descode = DESCoderUtil.getInstance();
    String key = descode.initkeyString();// cHZkc3V5dWg= cHZkc3V5dWg=
    System.out.println("密钥:" + key);
    System.out.println(descode.encryptNetString("南海是中国的 very good! oh haha $&**&", "tsyg=af$"));
    // System.out.println(decryptNetString("ZHg25iEgaOarDRbIfHNnXqPuMaOXPRo6CBTLUW2s8BOecSdJIoFQeI/g07ViN+KkxpJdW/ewNCQ=",
    // key));
  }
}
