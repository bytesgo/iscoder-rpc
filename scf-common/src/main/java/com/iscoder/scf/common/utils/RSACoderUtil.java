package com.iscoder.scf.common.utils;
...
public class RSACoderUtil {
   ...
   * @throws Exception
   */
  public static RSACoderUtil getInstance() {
    return new RSACoderUtil();
  }
  ...
  public String getStringPublicKey(Map<String, Object> map) {
    return Base64Util.encodeBase64String(getPublicKey(map));
  }
  ...
  public String getStringPrivateKey(Map<String, Object> map) {
    return Base64Util.encodeBase64String(getPrivateKey(map));
  }
  ...
  public String encryptByPrivateKeyString(String data, String key) throws Exception {
    return Base64Util.encodeBase64String(encryptByPrivateKey(data.getBytes(CHAR_ENCODING), Base64Util.decodeBase64(key)));
  }
  ...
  public String decryptByPrivateKey(String data, String key) throws Exception {
    return new String(decryptByPrivateKey(Base64Util.decodeBase64(data), Base64Util.decodeBase64(key)));
  }
  ...
  public byte[] decryptByPrivateKeyByte(String data, String key) throws Exception {
    return decryptByPrivateKey(Base64Util.decodeBase64(data), Base64Util.decodeBase64(key));
  }
  ...
  public String decryptByPublicKey(String data, String key) throws Exception {
    return new String(decryptByPublicKey(Base64Util.decodeBase64(data), Base64Util.decodeBase64(key)));
  }
  ...
  public String encryptByPublicKeyString(byte[] data, byte[] key) throws Exception {
    return Base64Util.encodeBase64String(encryptByPublicKey(data, key));
  }
  ...
  public String encryptByPublicKeyString(String data, String key) throws Exception {
    return encryptByPublicKeyString(data.getBytes(CHAR_ENCODING), Base64Util.decodeBase64(key));
  }
  ...
  public String encryptNet(String data, String module, String exponent) throws Exception {
    return Base64Util.encodeBase64String(encryptNet(data.getBytes(CHAR_ENCODING), Base64Util.decodeBase64(module), Base64Util.decodeBase64(exponent)));
  }
  ...
  public String dencryptNet(String data, String delement, String module) throws Exception {
    return new String(dencryptNet(Base64Util.decodeBase64(data), Base64Util.decodeBase64(delement), Base64Util.decodeBase64((module))));
  }
  ...
  public String getRSAPrivateKeyAsNetFormat(String encodedPrivatekey) {
    return getRSAPrivateKeyAsNetFormat(Base64Util.decodeBase64(encodedPrivatekey));
  }
  ...
  public String getRSAPublicKeyAsNetFormat(String encodedPrivatekey) {
    return getRSAPublicKeyAsNetFormat(Base64Util.decodeBase64(encodedPrivatekey));
  }
  ...
  private String getRSAPublicKeyModulus(String key) throws Exception {
    return b64encode(removeMSZero(getRSAPrivateCrtKey(Base64Util.decodeBase64(key)).getModulus().toByteArray()));
  }
  ...
  private String getRSAPublicKeyExponent(String key) throws Exception {
    return b64encode(removeMSZero(getRSAPrivateCrtKey(Base64Util.decodeBase64(key)).getPublicExponent().toByteArray()));
  }
  ...
  public static void main(String[] args) throws Exception {
    @SuppressWarnings("unused")
    RSACoderUtil rsa = RSACoderUtil.getInstance();
    // java公钥加密 私钥解密
    // S--------------------------------------------------------------------------
