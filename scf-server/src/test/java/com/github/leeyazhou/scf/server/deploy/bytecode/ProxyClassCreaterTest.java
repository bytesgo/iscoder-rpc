...
import com.github.leeyazhou.scf.server.deploy.bytecode.ProxyClassCreater;
...
public class ProxyClassCreaterTest {
  ...
  public void testCreateMethods() {
    ...
    for (Method m : uniqueMethodList) {
      ...
      String methodStr = pcc.createMethods("TestClass", m.getName(), allMethodList, uniqueNameList);
      System.out.println("method(" + m.getName() + ") source code:" + methodStr);
  ...
  public void testCodeSource() throws MalformedURLException {
    URL url = new URL("file", "", "E:/JavaWorkJar/scf/scf-server-2.0.0.jar");
