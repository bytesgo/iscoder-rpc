...
public class RSAUtil {
   ...
   * @throws Exception
   */
  public static RSAUtil getInstance() throws Exception {
    return new RSAUtil();
  }
   ...
   * @throws Exception
   */
  public static RSAUtil getInstance(String pubModulus, String pubExponent) throws Exception {
    return new RSAUtil(pubModulus, pubExponent);
  }
   ...
   * @throws Exception
   */
  private RSAUtil(String pubModulus, String pubExponent) throws Exception {
