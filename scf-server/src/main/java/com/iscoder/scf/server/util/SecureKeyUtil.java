...
import com.iscoder.scf.common.utils.RSACoderUtil;

public class SecureKeyUtil {

  static RSACoderUtil rsaHelper = RSACoderUtil.getInstance();
  /**
   * RSA密钥key
   */
  Map<String, Object> map = new HashMap<String, Object>();

  public SecureKeyUtil() {
  ...
  public static byte[] encryptByDesKey(byte[] data, byte[] key) throws Exception {
    DESCoderUtil desHelper = DESCoderUtil.getInstance();
