...
import com.iscoder.scf.server.deploy.hotdeploy.DynamicURLClassLoader;

public class CreateManagerTest {

  static {
    DOMConfigurator.configure(RootPath.projectRootPath + "config/log4j.xml");
  }

  @Test
  public void testCareteProxy() throws Exception {

    // IProxyFactory pf = (new
    // CreateManager()).careteProxy("D:/serviceframe_v2_II/service/deploy/demo",
