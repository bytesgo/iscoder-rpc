...
public class ServiceConfigTest {
  ...
  public void testCreateInstance() throws Exception {
    ...
    Assert.assertEquals("com.bj58.spat.scf.server.core.communication.tcp.SocketServer", sc.getString("scf.server.tcp.implement"));
    ...
    Assert.assertEquals("com.bj58.spat.scf.server.core.filter.ProtocolParseFilter",
        sc.getList("scf.server.tcp.filter.request", ",").get(0));
    Assert.assertEquals(1, sc.getList("scf.server.tcp.filter.response", ",").size());
    Assert.assertEquals("com.bj58.spat.scf.server.core.filter.ProtocolCreateFilter",
    ...
    Assert.assertEquals("com.bj58.spat.scf.server.core.communication.http.HttpServer", sc.getString("scf.server.http.implement"));
    ...
    Assert.assertEquals("com.bj58.spat.scf.server.core.communication.telnet.TelnetServer", sc.getString("scf.server.telnet.implement"));
